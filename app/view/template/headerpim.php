			...
			<div class="user-info-dropdown">
				<div class="dropdown">
					<a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
						...
						<span class="user-name">Pimpinan</span>
					</a>
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li>
						<a href="<?= BaseURL("pim")?>" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-home"></span><span class="mtext">Beranda</span>
						</a>
					</li>
					<li>
						<a href="<?=BaseURL("pim/konfirmasi")?>" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-box-1"></span><span class="mtext">Konfirmasi Permintaan</span>
						</a>
					</li>
						<a href="<?=BaseURL("laporan/laporan")?>" class="dropdown-toggle no-arrow">
