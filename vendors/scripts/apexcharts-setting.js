...
var options2 = {
	series: [{
		name: 'Pembelian',
		data: [BMbulan1, BMbulan2, BMbulan3, BMbulan4, BMbulan5, BMbulan6, BMbulan7, BMbulan8, BMbulan9, BMbulan10, BMbulan11, BMbulan12]
	}, {
		name: 'Penjualan',
		data: [BKbulan1, BKbulan2, BKbulan3, BKbulan4, BKbulan5, BKbulan6, BKbulan7, BKbulan8, BKbulan9, BKbulan10, BKbulan11, BKbulan12]
	}],
	chart: {
		height: 350,
		type: 'area',
	...
	xaxis: {
		categories: ['Jan', 'Feb', "Mar", "apr", "mei", "jun", "jul", "agts", "sep", "okt", "nov", "des"]
	},
	tooltip: {
		x: {
